...
*
* Modified version of Michael Main's June 12th 1998 Graph class, modified for
* ITC 322, Charles Sturt university
* 
...
public class Graph implements Cloneable
{
   ...
   **/   
   ...
   public void setEdges(int height, int width)
   {
	   this.edges = new boolean[(height*width)+1][(width*height)+1];//?
   }
   ...
   {
	   edges = new boolean[h][w];
	   labels = new Object[h*w];
   }
